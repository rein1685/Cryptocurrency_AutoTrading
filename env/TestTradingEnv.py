...
class TestTradingEnv(gym.Env):
    ...
    def __init__(self, df, lookback_window_size=128, initial_balance=10000, commission=0.00075, serial=False):
    ...
    def _next_observation(self):
        ...
        #print("obs 1 shape : {}".format(obs.shape))
        ...
        #print("obs 2 shape : {}".format(obs.shape))
